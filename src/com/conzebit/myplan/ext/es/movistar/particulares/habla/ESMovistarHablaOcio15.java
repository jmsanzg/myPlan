 ...
 * @author sanz
 */
public class ESMovistarHablaOcio15 extends ESMovistar {
	...
	public String getPlanName() {
		return "Habla Ocio 15";
	}
	
	public String getPlanURL() {
		return "http://www.tarifas.movistar.es/web/movistar/detalle-tarifas-voz-particulares?tipo=tarifas&name=Tarifa%20Habla%20Ocio%2015&impuesto=Sin%20impuestos&idContenido=9db6e229-7001-42aa-a061-e3a96ffefc46";
	}
		...
		for (Chargeable chargeable : data) {
			if (chargeable.getChargeableType() == Chargeable.CHARGEABLE_TYPE_CALL) {
				...
				if (call.getContact().getMsisdnType() == MsisdnType.ES_SPECIAL_ZER0) {
					...
					if (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY || hourOfDay < 8 || hourOfDay >= 16) {
