 ...
 * @author sanz
 */
public class ESMovistarHablaOcio extends ESMovistar {
    
	private double monthFee = 6;
	private double initialPrice = 0.15;
	private double pricePerSecond = 0.03 / 60;
	private double pricePerSecond2 = 0.18 / 60;
	...
	public String getPlanURL() {
		return "http://www.tarifas.movistar.es/web/movistar/detalle-tarifas-voz-particulares?tipo=tarifas&name=Tarifa%20Habla%20Ocio&impuesto=Sin%20impuestos&idContenido=fa8b7819-92a6-4f2a-bb3c-1cf42750943e";
	}
				...
				if (call.getContact().getMsisdnType() == MsisdnType.ES_SPECIAL_ZER0) {
					...
					if (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY) {
						...
						if (hourOfDay < 8 || hourOfDay >= 16) {
							...
							type = Type.OUTSIDE_PLAN;
							callPrice += initialPrice + (call.getDuration() * pricePerSecond2);
						}
					}
				}
