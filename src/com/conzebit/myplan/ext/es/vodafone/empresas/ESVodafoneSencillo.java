 ...
 * @author sanz
 */
public class ESVodafoneSencillo extends ESVodafone {
    
	private double monthFee = 8.0;
	private double minimumMonthFee = 4.0;
	private double initialPrice = 0.15;
	private double pricePerSecond = 0.09 / 60;
	private double smsPrice = 0.15;
    
	public String getPlanName() {
		return "Plan Sencillo";
	}
	
	public String getPlanURL() {
		return "http://www.vodafone.es/empresas/tarifas/voz/sencillo/";
	}
