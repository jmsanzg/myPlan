...
/**
 * Vodafone A mi Aire Simple.
 * http://vodafone.es/particulares/tarifas/telefonia_movil/contrato/ami_aire/descripcion/
 * @author sanz
 */
public class ESVodafoneAireSimple extends ESVodafone {
    
	private double minimumMonthFee = 9;
	private double initialPrice = 0.15;
	private double pricePerSecond = 0.119 / 60;
	private double smsPrice = 0.15;
    
	public String getPlanName() {
		return "A mi Aire Simple";
	}
	
	public String getPlanURL() {
		return "http://www.vodafone.es/particulares/tarifas/telefonia_movil/contrato/ami_aire/descripcion/?tab_ji5d91d961y7w3ac=v2poz7lx9da81xqz#iveizo503hjs9bhfq";
	}
