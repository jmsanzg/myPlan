...
/**
 * MasMovil Tarifa Movil Today.
 * 
 * @author DarkEagle82 aka Sergi (sergi at nucl3ar dot net)
 */
public class ESMasMovilTarifaMovilToday extends ESMasMovil {
	...
	public String getPlanName() {
		return "Tarifa MovilToday 450MB";
	}
	
	public String getPlanURL() {
		return "http://www.masmovil.es/promocion-moviltoday";
	}
