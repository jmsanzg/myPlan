...
public class ESMasMovilTarifa3 extends ESMasMovil {
	...
	public String getPlanURL() {
		return "http://www.masmovil.es/telefonia-movil";
	}
	...
	public PlanSummary process(ArrayList<Chargeable> data) {
		...
		if (globalPrice < minimumMonthFee) {
			ret.addPlanCall(new PlanChargeable(new ChargeableMessage(ChargeableMessage.MESSAGE_MINIMUM_MONTH_FEE), minimumMonthFee - globalPrice, this.getCurrency(), PlanChargeable.Type.MINIMUM_MONTH_FEE));
		}
		return ret;
	}
}