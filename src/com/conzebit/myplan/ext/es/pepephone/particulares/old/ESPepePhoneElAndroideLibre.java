 ...
 * @author sanz
 */
public class ESPepePhoneElAndroideLibre extends ESPepePhone {
	...
	public String getPlanName() {
		return "El Androide Libre (inc 500MB datos)";
	}
	
	public String getPlanURL() {
		return "http://www.pepephone.com/promo/elandroidelibre/";
	}
