...
/**
 * Tuenti Bono 3GB datos.
 * @author mcornella
 */
public class ESTuentiBono3GB extends ESTuenti {
    
	private double monthFee = 15.0;
    ...
    public String getPlanName() {
		return "Tuenti Bono 3GB";
	}

	public String getPlanURL() {
		return "http://www.tuenti.com/movil/tarifas";
	}
