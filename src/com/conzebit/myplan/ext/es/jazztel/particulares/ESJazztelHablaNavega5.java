...
/**
 * Jazztel Habla Navega 5.
 * 
 * @author sanz
 */
public class ESJazztelHablaNavega5 extends ESJazztel {
    
	private double monthFee = 11.95;
	private double minimumMonthFee = 5;
	...
	public String getPlanName() {
		return "Habla Navega 5";
	}
	
	public String getPlanURL() {
		return "http://hogar.movil.jazztel.com/telefonia-movil/tarifa-llama-y-navega-jazzmovil-5";
	}
